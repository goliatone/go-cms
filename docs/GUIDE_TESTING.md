...
| `widgets` | `widgets.NewService(defRepo, instRepo, trRepo, ...opts)` | `WithClock`, `WithIDGenerator`, `WithAreaDefinitionRepository`, `WithAreaPlacementRepository`, `WithRegistry` |
