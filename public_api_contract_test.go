...
func TestPublicContractsDoNotReferenceInternalPackages(t *testing.T) {
	...
	types := map[string]reflect.Type{
		...
		"cms.AdminContentFamilyReadService":          reflect.TypeFor[cms.AdminContentFamilyReadService](),
		"cms.AdminContentTranslationWriteService":    reflect.TypeFor[cms.AdminContentTranslationWriteService](),
		...
		"cms.AdminContentFamilyRecord":               reflect.TypeFor[cms.AdminContentFamilyRecord](),
		"cms.AdminContentFamilyListResult":           reflect.TypeFor[cms.AdminContentFamilyListResult](),
		"cms.AdminContentListOptions":                reflect.TypeFor[cms.AdminContentListOptions](),
		"cms.AdminContentFamilyListOptions":          reflect.TypeFor[cms.AdminContentFamilyListOptions](),
		"cms.AdminContentGetOptions":                 reflect.TypeFor[cms.AdminContentGetOptions](),
		"cms.AdminContentFamilyReadUnsupportedError": reflect.TypeFor[cms.AdminContentFamilyReadUnsupportedError](),
		...
		"cms.AdminContentUpdateTranslationRequest":   reflect.TypeFor[cms.AdminContentUpdateTranslationRequest](),
